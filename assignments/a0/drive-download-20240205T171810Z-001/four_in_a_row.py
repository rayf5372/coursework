...
class FourInARow:
    ...
    - p1_human: True if Player 1 is a human player
    - p2_human: True if Player 2 is a human player
    - result: outcome of a game
    - board: the current state of the board
    - p1_to_play: True if it is Player 1's turn to play
