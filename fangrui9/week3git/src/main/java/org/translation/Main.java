...
public class Main {
    ...
    public static void runProgram(Translator translator) {
        ...
        while (true) {
            ...
            String countryCode = c.fromCountry(country);
            ...
            String languageCode = l.fromLanguage(language);
    ...
    private static String promptForCountry(Translator translator) {
        ...
        CountryCodeConverter c = new CountryCodeConverter();
        countries.replaceAll(c::fromCountryCode);
    ...
    private static String promptForLanguage(Translator translator, String country) {
        ...
        LanguageCodeConverter l = new LanguageCodeConverter();
        languages.replaceAll(l::fromLanguageCode);
